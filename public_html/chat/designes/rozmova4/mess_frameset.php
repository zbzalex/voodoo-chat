...
} else if ($chat_type == "reload") {
    $shower = $chat_url . "messages.php?session=$session";
} else if ($chat_type == "php_tail") {
    $shower = $chat_url . "tail.php?session=$session";
} else if ($chat_type == "js_tail") {
    $shower = $chat_url . "js_frameset.php?session=$session";
}
?>
<script>
    function hide_box() {
...
<iframe id="board_div" name="message_box" src="about:blank" frameborder="no" framespacing="0" border="0" borderwidth="0"
        scrolling="auto">
</iframe>

<iframe id="board_header" name="closebox" src="" frameborder="no" framespacing="0" border="0" borderwidth="0"
        scrolling="no">
</iframe>
...
<iframe id="messages_div" name="voc_shower"
        src="<?php echo $shower . (($priv_frame && $chat_type == "tail") ? "&t=n" : ""); ?>" frameborder="no"
        framespacing="0" border="1" borderwidth="0" scrolling="auto">
</iframe>
</body>
</html>
