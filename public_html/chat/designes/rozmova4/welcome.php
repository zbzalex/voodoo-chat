...
<center>
    <table border="0" cellspacing="8" width="720">
        <form action="<?php echo $chat_url; ?>voc.php" method="POST" target="_parent">
            ...
            <tr>
                <td rowspan="2" valign="top" width="250"><h3><?php echo $w_title ?></h3>
                ...
                <td valign="top">
                    <table>
                        <tr>
                            <td><?php echo $w_enter_login_nick; ?>:</td>
                            <td><input type="text" name="user_name" size=15 value="<?php echo $c_user_name; ?>"
                                       class="input" tabindex="100"></td>
                            <td> &nbsp; <input type="Submit" value="<?php echo $w_login_button ?>" class="input"
                                               tabindex="105"></td>
                        </tr>
                        <tr>
                            <td colspan="3"><small><?php echo $w_login; ?></small></td>
                        </tr>
                        <tr>
                            <td><?php echo $w_password; ?>:</td>
                            <td><input type="password" name="password" size=15 value="" class="input" tabindex="101">
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="3"><?php if (!$club_mode) echo "<small>" . $w_for_registered . "</small>"; ?></td>
                        </tr>

                        <?php if (count($room_ids) > 1){ ?>
                        <tr>
                            <td><?php echo $w_select_room; ?>:</td>
                            <td><select name="room" class="input"
                                        onchange="javascript:parent.voc_shower.location.href='shower.php?design=<?php echo $design; ?>&room='+this.options[this.selectedIndex].value;"
                                        tabindex="102">
                                    <?php
