...
<center>
    <table border="0" cellpadding="0" cellspacing="4">
        <tr>
            <td colspan="5" background="<?php echo $current_design; ?>images/hor_dot_line.gif" align="left"><img
                        src="<?php echo $current_design; ?>images/hor_dot_line.gif" width="10" height="1"></td>
        </tr>

        <tr>
            <td rowspan="3" background="<?php echo $current_design; ?>images/vert_dot_line.gif" valign="top"><img
        ...
        <tr>
            <td><?php echo $out_messages; ?></td>
            <td><?php echo $out_users; ?></td>
        </tr>
        <tr>
            <td colspan="5" background="<?php echo $current_design; ?>images/hor_dot_line.gif" align="left"><img
                        src="<?php echo $current_design; ?>images/hor_dot_line.gif" width="10" height="1"></td>
