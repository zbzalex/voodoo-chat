                ...
                <tr>
                    <td width="30%">&nbsp;&nbsp;
                        <a style="text-decoration: none;" target="_blank"
                           href="<?php echo $chat_url; ?>board_send.php?session=<?php echo $session; ?>&send_to_id=<?php echo $user_id; ?>"><font
                                    face="Verdana, Tahoma, Arial" size=1 color="#bf0d0d">
                                <b>[ <?= $w_roz_offline_pm; ?> ]</b>
                        </a>&nbsp;
                    </td>
                    <td width="147" height="20">
                        <img src="<?php echo $current_design; ?>main/profile_05.jpg" width="147"
                             height="20" alt="">
                    </td>
                    <td width="70%" height="20" bgcolor="#7ec63e" align="right">
                        <font face="Verdana, Tahoma, Arial" size=1 color="#FFFFFF">
                            Ссылка на профиль :
                            <b><?php echo $chat_url . "users/" . $current_user->nickname; ?>&nbsp;&nbsp;</b>
                        </font>
                    </td>
                </tr>
            </table>
