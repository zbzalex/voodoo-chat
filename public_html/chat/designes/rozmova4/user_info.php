                                ...
                                <DD>
                                        <DIV class="reducer">
                                                ...
                                                <TR>
                                                        ...
                                                        <TD><INPUT type="button" class="input_button" value="�������" onClick="location.href='user_info.php?session=<?=$session?>&op=exchange';"></TD>
                                                </TR>
                                                <TR>
                                                        <td><?=$w_money_transfer?></td>
                                                        <TD colspan="2">
                                                                <INPUT type="button" class="input_button" value="�������" onClick="location.href='user_info.php?session=<?=$session?>&op=transfer';">
                                                        </TD>
                                                </TR>
                                                </table>
                                        </div>
