...
<FORM method="post" action="user_info_update.php" enctype="multipart/form-data">
    ...
    <DIV style="background: ButtonFace; padding: 1em;">
        <DL class="tabsheets">
                ...
                <DIV class="reducer">
                    <table cellspacing="2" cellpadding="2" border="0">
                        ...
                        <TR>
                            ...
                            <TD>
                                <INPUT type="text" size="15" name="icquin"
                                       value="<?php echo $current_user->icquin; ?>" class="input">
                            </TD>
                        </TR>
                        <tr>
                            <td height="100%">&nbsp;</td>
            ...
            <DD>
                <DIV class="reducer">
                    <INPUT type=checkbox name="allow_webcam"
                           value="1" <?php if ($current_user->allow_webcam == 1) echo " checked"; ?>><B><?php echo $w_webcam_show; ?></B><BR><SMALL><?= $w_webcam_note ?></SMALL>
                    <TABLE border="0" cellspacing="2" cellpadding="2">
                        <TR>
                            <TD width="30%"><?php echo $w_webcam_ip; ?>
                            </TD>
                            <TD>
                                <INPUT type="text" size="15" name="webcam_ip"
                                       value="<?php echo $current_user->webcam_ip; ?>" class="input">
                            </TD>
                        </TR>
                        <TR>
                        ...
                        <TR>
                            ...
                            <TD>
                                <INPUT type="text" size="15" name="webcam_port"
                                       value="<?php echo $current_user->webcam_port; ?>" class="input">
                            </TD>
                        </TR>
                        <tr>
                            <td colspan="2" align="right">
                    ...
                    <table>
                        ...
                        if ($allow_multiply) {
                            ...
                            <TR>
                                ...
                                <TD>
                                    <INPUT type=checkbox value=1
                                           name="use_old_paste" <?php if ($current_user->use_old_paste == 1) echo " checked"; ?>>
                                </TD>
                            </TR>
                        <?php } ?>
                        <TR>
                            ...
                            <TD>
                                <INPUT type=checkbox value=1
                                       name="reduce_traffic" <?php if ($current_user->reduce_traffic == 1) echo " checked"; ?>>
                            </TD>
                        </TR>
                        <TR>
                            ...
                            <TD>
                                <INPUT type=checkbox value=1
                                       name="play_sound" <?php if ($current_user->play_sound == 1) echo " checked"; ?>>
                            </TD>
                        </TR>
                        <tr>
                            <td colspan="2" align="right">
