...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" background="<?php echo $current_design;?>grunge/grunge_02.gif">
  <tr align="center">
    <td width="10%"><b><a href="javascript:;" onclick="javascript:open_win('http://192.168.4.92/rules.php', 'rules');"><font color=red>�������</font></a></b></td>
...
<td width="10%"><b><a href="logout.php?session=<?php echo $session;?>" target="_parent"><font color=white><?php echo ucfirst(�����); ?></font></a></b></td>
  </tr>
</table>
</body>
</html>