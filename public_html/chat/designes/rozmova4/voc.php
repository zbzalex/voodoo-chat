        ...
        <frameset rows="24,*" bordercolor="#3D4976">
            ...
            if ($cu_array[USER_CLASS] > 0 && $ar_rooms[$room_id][ROOM_PREMODER] == 1) { ?>
                <frameset rows="40%,30%, 30%, 80" bordercolor="#3D4976" framespacing="3">
                    <frame name="voc_shower" src="<?php echo $current_design; ?>blank.html" marginwidth="0"
                    ...
                    <frame name="voc_shower_priv" src="<?php echo $current_design; ?>blank.html" marginwidth="0"
                           marginheight="0" scrolling="auto" frameborder="0">
                    <frame src="<?php echo $chat_url; ?>approve.php?session=<?php echo $session; ?>" name="voc_approve"
            ...
            <frameset name="pvt_frameset" rows="*, 30%, 80" bordercolor="#3D4976" framespacing="3">
                ...
                <frameset name="pvt_frameset" rows="*, 30%, 60" bordercolor="#3D4976" framespacing="3">
                    ...
                    <frameset rows="24,*" bordercolor="#3D4976" framespacing="1">
                        <frame name="menu_private" src="<?php echo $current_design; ?>blank.html" marginwidth="0"
            ...
            <frameset rows="*, 85" bordercolor="#3D4976" framespacing="1" frameborder="YES" scrolling=auto>
                ...
                <frameset rows="*, 65" bordercolor="#3D4976" framespacing="1" frameborder="YES" scrolling=auto>
                    ...
                    <frame src="<?php echo $current_design; ?>status_blank.php?session=<?php echo $session; ?>"
                           name="voc_who_visible" marginwidth="0" marginheight="0" frameborder="0">
                    <frame src="<?php echo $current_design; ?>status_blank.php?session=<?php echo $session; ?>"
                           name="voc_rooms" marginwidth="0" marginheight="0" frameborder="0">
                </frameset>
                <frame name="voc_who" src="<?php echo $current_design; ?>blank.html" marginwidth="0" marginheight="0"
