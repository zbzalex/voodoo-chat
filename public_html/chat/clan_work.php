    ...
    case "clan_money_transfer":
        ...
        <form method=post action="clan_work.php">
            ...
            <table border="0" cellpadding="2" cellspacing="2" width="500">
                <tr>
                    <td><b><font color="red"><?= $error_text ?></font></b></td>
                </tr>
                <tr>
                    <td><?= $w_money ?>:</td>
                    <td><b><?= $current_clan->credits ?></b></td>
                </tr>
                <tr>
                    <td><?= $w_money_transfer_amount ?>:</td>
                    <td><b><input type="text" name="crd_transfer" value="<?= intval($crd_transfer) ?>"
                                  class="input"></b></td>
                </tr>
                <tr>
                    <td><?= $w_roz_user ?>:</td>
                    <td><input type="text" name="user_transfer" value="<?= $user_transfer ?>" class="input"></td>
                </tr>
                <tr>
                    <td colspan=2><small><?= $w_money_transfer_password ?></small></td>
                </tr>
                <tr>
                    <td><?= $w_password ?>:</td>
                    <td><b><input type="password" name="pass_transfer" class="input"></b></td>
                </tr>
            </table>
