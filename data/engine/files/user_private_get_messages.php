...
if ($cu_array[USER_CLASS] > 0) {
    proceed_file($data_path . "user-privates/groups/adminz.msg");
    proceed_file($data_path . "user-privates/groups/shamanz.msg");
}
...
if ($cu_array[USER_GENDER] == GENDER_BOY) {
    ...
    $board_file = "girlz.msg";
    $group_id = 4;
} else if ($cu_array[USER_GENDER] == GENDER_THEY or intval($cu_array[USER_GENDER]) == 0 or intval($cu_array[USER_GENDER]) == -1) {
    $board_file = "they.msg";
    $group_id = 5;
}
if ($board_file == "") {
